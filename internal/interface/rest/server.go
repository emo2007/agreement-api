...
import (
	...
	"github.com/emo2007/block-accounting/examples/agreement-api/internal/pkg/config"
	"github.com/emo2007/block-accounting/examples/agreement-api/internal/pkg/logger"
	"github.com/emo2007/block-accounting/examples/agreement-api/internal/usecases/repository"
...
func (s *Server) buildRouter() {
	...
	router.Get("/order/{orger_id}/delivered", s.handle(s.handleOrderDelivered, "order_delivered"))
